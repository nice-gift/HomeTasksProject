package by.kursy.luschik.javastages.stage12.taskB2.controller;

import by.kursy.luschik.javastages.stage12.taskB2.modellogic.Mirror;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Mirror.isNumsInMirrorView(array);
